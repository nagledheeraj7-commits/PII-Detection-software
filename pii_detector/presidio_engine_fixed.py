"""
Presidio Engine - Fixed Version with compatibility handling
"""
...
try:
    ...
    from presidio_analyzer.context import RecognizerContext
...
class PresidioPIIEngine:
    ...
    def __init__(self):
        """Initialize the Presidio engine"""
