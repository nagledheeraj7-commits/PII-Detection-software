"""
Presidio Engine for PII detection
"""
...
try:
    from presidio_analyzer import AnalyzerEngine, PatternRecognizer, EntityRecognizer, RecognizerResult
...
class PresidioPIIEngine:
    ...
    def __init__(self):
        """Initialize the Presidio engine with custom recognizers"""
        self.analyzer = self._setup_analyzer()
        self.anonymizer = AnonymizerEngine()
    
    def _setup_analyzer(self) -> AnalyzerEngine:
        """Setup analyzer with custom recognizers for Indian PII"""
        # Create registry
    ...
    def analyze_text(self, text: str, language: str = "en") -> List[RecognizerResult]:
        ...
        try:
            # Use the correct analyze method with safe string
